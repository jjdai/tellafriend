<?php
function smarty_modifier_xoops_tellafriend($string,$subject='', $protocole=0)
{                   
  ...
  if ($protocole==0)  {
    ...
    $url = str_replace('http', '__protocole__',  $target_uri);      
  
  	return XOOPS_URL.'/modules/tellafriend/index.php?target_uri='.rawurlencode( $url).'&amp;subject='.rawurlencode( $subject ) ;
  }
